...
export const LEVELS = [
  // ── World 1: Grassland ──────────────────────────────────────────────
  {
    ...
    pipes: [{ x: 1140, y: GROUND_Y - 80, w: 70, h: 80 }, { x: 2620, y: GROUND_Y - 120, w: 70, h: 120 }],
    blocks: [
  ...
  bossLevel('1-2', 'overworld', makeBoss(900, 3, 1.4, 220), {
    blocks: brickRow(200, GROUND_Y - 160, ['brick', 'question:mushroom', 'brick']),
  ...
  // ── World 2: Underground ─────────────────────────────────────────────
  {
    ...
    pipes: [{ x: 900, y: GROUND_Y - 90, w: 70, h: 90 }, { x: 2900, y: GROUND_Y - 100, w: 70, h: 100 }],
    blocks: [
  ...
  bossLevel('2-2', 'underground', makeBoss(1000, 4, 1.7, 250), {
    blocks: brickRow(200, GROUND_Y - 160, ['brick', 'question:fireflower', 'brick']),
    coins: coinLine(420, GROUND_Y - 90, 3),
  }),
  ...
  // ── World 3: Sky ─────────────────────────────────────────────────────
  {
    ...
    pipes: [{ x: 1000, y: GROUND_Y - 90, w: 70, h: 90 }, { x: 2900, y: GROUND_Y - 100, w: 70, h: 100 }],
    blocks: [
  ...
  bossLevel('3-2', 'sky', makeBoss(1000, 4, 1.9, 250), {
    blocks: brickRow(200, GROUND_Y - 160, ['brick', 'question:star', 'brick']),
    coins: coinLine(420, GROUND_Y - 90, 3),
  }),
  ...
  // ── World 4: Castle (final) ──────────────────────────────────────────
  {
    ...
    pipes: [{ x: 950, y: GROUND_Y - 90, w: 70, h: 90 }, { x: 1900, y: GROUND_Y - 115, w: 70, h: 115 }, { x: 3300, y: GROUND_Y - 100, w: 70, h: 100 }],
    blocks: [
  ...
  bossLevel('4-2', 'castle', makeBoss(1100, 6, 2.1, 300), {
    blocks: [...brickRow(200, GROUND_Y - 160, ['brick', 'question:fireflower', 'brick']), ...brickRow(500, GROUND_Y - 160, ['brick', 'question:1up', 'brick'])],
