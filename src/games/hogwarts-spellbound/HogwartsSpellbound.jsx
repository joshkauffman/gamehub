...
// dry-witted cat familiar tags along, corridors escalate toward each
// area's guardian, and spellcraft/loot/XP/levels drive progress toward a
// three-act arc — the castle, the Chamber of Secrets, and finally the
// Dark Lord's return — ending in a duel with Lord Voldemort himself.
//
// Started life sharing dungeon-crawler-max/DungeonCrawlerMax.jsx's engine
// (top-down rooms/corridors, melee + spellcasting, optional local
// 2-player co-op) but now diverges from it: a three-act structure instead
// of a flat floor list, a Death Eater/Dementor faction alongside the
// creature roster, and an actual named antagonist driving the back half
// of the game instead of an escalating boss gauntlet. Everything lives in
// one plain object (`g`) mutated in place every frame and drawn straight
// to canvas — same pattern as this hub's other 2D canvas games: refs hold
// state so the render loop never fights React re-renders, and React only
// owns the intro/win overlay screens.
...
// ── Content ──────────────────────────────────────────────────────────
const FLOOR_THEMES = [
  { act: 'Act I: First Year', name: 'The Entrance Hall', wallColor: '#3a2f1e', floorColor: '#5c4a30', accent: '#d4af37', monsterPool: ['flobberworm', 'niffler', 'cornishpixie'], boss: 'trickstepslime' },
  { act: 'Act I: First Year', name: 'Charms Corridor', wallColor: '#2a3040', floorColor: '#3f4a5c', accent: '#8fd3ff', monsterPool: ['gardengnome', 'redcap', 'cornishpixie'], boss: 'gnomechieftain' },
  { act: 'Act I: First Year', name: 'The Trophy Room', wallColor: '#3a1a1a', floorColor: '#5c2a2a', accent: '#ffd700', monsterPool: ['suitofarmor', 'gardengnome', 'doxy'], boss: 'rustedknight' },
  { act: 'Act I: First Year', name: 'Potions Dungeons', wallColor: '#131a13', floorColor: '#1f2f1f', accent: '#6bff8f', monsterPool: ['studyskeleton', 'flobberworm', 'rustedcauldron'], boss: 'anatomyskeleton' },
  { act: 'Act I: First Year', name: 'The Greenhouses', wallColor: '#16240f', floorColor: '#263d18', accent: '#9fe066', monsterPool: ['bowtruckle', 'acromantula', 'redcap'], boss: 'whompingwillow' },
  { act: 'Act I: First Year', name: 'The Owlery', wallColor: '#1a1a2e', floorColor: '#2a2a4a', accent: '#c9a6ff', monsterPool: ['doxy', 'fwooper', 'cornishpixie'], boss: 'belfrydoxy' },
  { act: 'Act I: First Year', name: 'The Grand Staircase', wallColor: '#2f2015', floorColor: '#4a3322', accent: '#e0b060', monsterPool: ['suitofarmor', 'gardengnome', 'runespoor'], boss: 'runespoorelder' },
  { act: 'Act I: First Year', name: 'The Quidditch Pitch', wallColor: '#16321a', floorColor: '#234a28', accent: '#ffd700', monsterPool: ['fwooper', 'doxy', 'hinkypunk'], boss: 'roguebludger' },
  { act: 'Act I: First Year', name: 'The Divination Tower', wallColor: '#241a30', floorColor: '#3a2a4a', accent: '#d8b8ff', monsterPool: ['frostsprite', 'schoolghost', 'hinkypunk'], boss: 'frozensentinel' },
  { act: 'Act I: First Year', name: 'The Great Hall, After Hours', wallColor: '#17130a', floorColor: '#2b2413', accent: '#ffd700', monsterPool: ['schoolghost', 'suitofarmor', 'gardengnome'], boss: 'giltsentinel' },
  { act: 'Act I: First Year', name: 'Hogsmeade Village Outskirts', wallColor: '#223038', floorColor: '#34464f', accent: '#cfe8ff', monsterPool: ['redcap', 'niffler', 'doxy'], boss: 'hippogriffmatriarch' },
  { act: 'Act I: First Year', name: 'The Forbidden Forest Edge', wallColor: '#0f1a0f', floorColor: '#1a2e1a', accent: '#6b8f4a', monsterPool: ['acromantula', 'manticorecub', 'bowtruckle'], boss: 'mountaintroll' },
  { act: 'Act I: First Year', name: "Hagrid's Hut & Grounds", wallColor: '#2a2015', floorColor: '#40311f', accent: '#c9a060', monsterPool: ['salamander', 'manticorecub', 'niffler'], boss: 'skewtalpha' },
  { act: 'Act I: First Year', name: 'The Room of Requirement', wallColor: '#1f1428', floorColor: '#331f45', accent: '#ff9fe0', monsterPool: ['boggart', 'ravenoustextbook', 'schoolghost'], boss: 'manticore' },
  { act: 'Act II: Second Year', name: 'The Library, Restricted Section', wallColor: '#241c10', floorColor: '#3a2e1a', accent: '#e0c080', monsterPool: ['ravenoustextbook', 'boggart', 'hinkypunk'], boss: 'forbiddengrimoire' },
  { act: 'Act II: Second Year', name: 'Astronomy Tower', wallColor: '#0a0e1e', floorColor: '#141c34', accent: '#ffffff', monsterPool: ['banshee', 'schoolghost', 'frostsprite'], boss: 'peeves' },
  { act: 'Act II: Second Year', name: "Moaning Myrtle's Bathroom", wallColor: '#16242a', floorColor: '#223640', accent: '#8fd3ff', monsterPool: ['boggart', 'banshee', 'schoolghost'], boss: 'boggartking' },
  { act: 'Act II: Second Year', name: 'The Chamber of Secrets', wallColor: '#0a140a', floorColor: '#142a14', accent: '#6bff6b', monsterPool: ['runespoor', 'acromantula', 'banshee'], boss: 'basilisk' },
  { act: 'Act III: The Dark Lord Returns', name: 'Azkaban Fortress', wallColor: '#12161c', floorColor: '#1e242c', accent: '#4a90d9', monsterPool: ['dementor', 'deatheater', 'schoolghost'], boss: 'dementorwarden' },
  { act: 'Act III: The Dark Lord Returns', name: 'The Graveyard at Little Hangleton', wallColor: '#0f140a', floorColor: '#1c2412', accent: '#8fff4a', monsterPool: ['deatheater', 'dementor', 'acromantula'], boss: 'nagini' },
  { act: 'Act III: The Dark Lord Returns', name: 'The Battle of Hogwarts', wallColor: '#2a0a0a', floorColor: '#3a1414', accent: '#ff4444', monsterPool: ['deatheater', 'dementor', 'boggart'], boss: 'voldemort' },
]

const MONSTER_DEFS = {
  flobberworm: { name: 'Flobberworm', kind: 'ooze', color: '#8a7a5a', accent: '#4a3f28', r: 15, hp: 16, atk: 3, speed: 1.6, xp: 8, lore: "A sluggish, foot-long worm with no bite and no brain to speak of. Professor Sprout insists they're excellent for essay practice. Nobody agrees." },
  niffler: { name: 'Niffler', kind: 'beast', color: '#3a2a1a', accent: '#d4af37', r: 13, hp: 12, atk: 2, speed: 2.6, xp: 7, lore: "A burrowing, platypus-nosed creature with an incurable addiction to anything that glitters. Useful for sniffing out buried treasure \u2014 and for stealing it right back." },
  cornishpixie: { name: 'Cornish Pixie', kind: 'flyer', variant: 'insect', color: '#3a7fd6', accent: '#bfe0ff', r: 11, hp: 9, atk: 2, speed: 2.2, xp: 6, lore: "Electric-blue, mischievous, and nearly impossible to catch once loosed indoors. A certain professor once released a cageful into a classroom without thinking it through." },
  gardengnome: { name: 'Garden Gnome', kind: 'humanoid', variant: 'goblin', color: '#8a6a3a', accent: '#c9a060', r: 15, hp: 20, atk: 4, speed: 1.7, xp: 10, lore: "A garden pest with a face like a knobbly potato and a mouth full of insults. Traditionally dealt with by picking it up, spinning it around, and launching it over a hedge." },
  redcap: { name: 'Red Cap', kind: 'humanoid', variant: 'small', color: '#7a3a3a', accent: '#ff4040', r: 13, hp: 11, atk: 2, speed: 2.8, xp: 6, lore: "A vicious little goblin-thing that haunts old battlefields and dungeons, drawn to violence like a moth to flame. Slow enough to outrun, if you're paying attention." },
  doxy: { name: 'Doxy', kind: 'flyer', variant: 'bat', color: '#4a2a4a', accent: '#ff6bd0', r: 13, hp: 14, atk: 3, speed: 3.0, xp: 9, lore: "A biting fairy with a double row of venomous teeth, often mistaken for a friendly pixie right up until it draws blood." },
  acromantula: { name: 'Acromantula', kind: 'arachnid', color: '#1a1a1a', accent: '#ff5566', r: 13, hp: 13, atk: 3, speed: 2.0, xp: 8, lore: "An eight-eyed spider the size of a cart horse, capable of speech and disturbingly fond of it. Found in colonies deep in the Forbidden Forest \u2014 never just one." },
  studyskeleton: { name: 'The Study-Skeleton', kind: 'humanoid', variant: 'bone', color: '#e8dcc0', accent: '#2a2a2a', r: 16, hp: 24, atk: 5, speed: 1.5, xp: 12, lore: "A teaching skeleton, borrowed from the Potions storeroom and never quite put back properly. It remembers every detention it's ever witnessed." },
  schoolghost: { name: 'Wandering School Ghost', kind: 'spectral', color: '#cfe8ff', accent: '#7fa6ff', r: 15, hp: 18, atk: 4, speed: 1.8, xp: 10, lore: "One of the castle's many dead, still wandering the corridors long after the lesson ended. Mostly harmless. Mostly." },
  suitofarmor: { name: 'Animated Suit of Armor', kind: 'golem', color: '#8a8a8a', accent: '#ffd700', r: 16, hp: 22, atk: 4, speed: 1.4, xp: 9, lore: "Ceremonial armor left standing in draughty corridors for centuries. Occasionally it decides it's had enough of being decorative." },
  runespoor: { name: 'Runespoor', kind: 'serpent', color: '#6a9a4a', accent: '#3d4f2c', r: 12, hp: 14, atk: 3, speed: 2.0, xp: 8, lore: "A three-headed serpent, each head with a separate \u2014 and often conflicting \u2014 job: one plans, one dreams, and one just wants to bite something." },
  hinkypunk: { name: 'Hinkypunk', kind: 'orb', color: '#ffcf60', accent: '#ffffff', r: 12, hp: 13, atk: 3, speed: 3.2, xp: 9, lore: "A one-legged wisp that carries a lantern through fog and marshland, luring the unwary off solid ground. Looks harmless. Isn't." },
  bowtruckle: { name: 'Bowtruckle', kind: 'plant', color: '#4a6a3a', accent: '#8fe08a', r: 14, hp: 19, atk: 4, speed: 1.2, xp: 10, lore: "A splinter-thin tree guardian, easy to mistake for a twig until it's already climbing your sleeve. Fiercely protective of its home tree." },
  frostsprite: { name: 'Frost Sprite', kind: 'imp', variant: 'frost', color: '#7fd0ff', accent: '#eaffff', r: 13, hp: 15, atk: 3, speed: 2.4, xp: 9, lore: "A small, glinting spirit that trails frost wherever it drifts. Beautiful to look at, miserable to touch." },
  rustedcauldron: { name: 'Rusted Cauldron Guardian', kind: 'golem', variant: 'rust', color: '#a05a30', accent: '#ffcf80', r: 16, hp: 23, atk: 5, speed: 1.6, xp: 11, lore: "A cauldron left brewing for far too long, until whatever was inside stopped being a potion and started being a problem." },
  fwooper: { name: 'Fwooper', kind: 'flyer', variant: 'harpy', color: '#ff6b9d', accent: '#ffe066', r: 11, hp: 12, atk: 2, speed: 3.6, xp: 8, lore: "A garishly colored songbird whose song, left unchecked, will drive a listener slowly and cheerfully insane. Sold with a Silencing Charm for a reason." },
  salamander: { name: 'Salamander', kind: 'imp', variant: 'fire', color: '#ff6b4a', accent: '#ffd34d', r: 13, hp: 17, atk: 4, speed: 2.6, xp: 10, lore: "A small fire-dwelling lizard that lives happily in flame and dies the moment it leaves it. Prized \u2014 and expensive \u2014 as a Potions ingredient." },
  manticorecub: { name: 'Manticore Cub', kind: 'beast', variant: 'wolf', color: '#8a5a3a', accent: '#e8c090', r: 15, hp: 20, atk: 4, speed: 2.2, xp: 10, lore: "A young manticore: lion's body, scorpion's tail, a disconcertingly human face. Not yet fully grown. Still faster than you." },
  ravenoustextbook: { name: 'Ravenous Textbook', kind: 'mimic', color: '#6b3a1a', accent: '#ffe08a', r: 13, hp: 16, atk: 3, speed: 1.8, xp: 9, lore: "A book from the Restricted Section that stopped waiting to be checked out. Best approached with gloves \u2014 or not at all." },
  boggart: { name: 'Boggart', kind: 'humanoid', variant: 'shadow', color: '#2a2a3a', accent: '#9a6bff', r: 15, hp: 21, atk: 5, speed: 2.0, xp: 11, lore: "A shape-shifter that takes the form of whatever you fear most. Nobody has ever seen its true shape, and nobody wants to." },
  banshee: { name: 'Banshee', kind: 'spectral', variant: 'banshee', color: '#d8e8ff', accent: '#8fd3ff', r: 13, hp: 18, atk: 4, speed: 3.0, xp: 10, lore: "A wailing spirit whose scream is said to foretell death. Mostly it just startles people badly enough to make that prophecy feel personal." },
  dementor: { name: 'Dementor', kind: 'spectral', variant: 'banshee', color: '#1a1a24', accent: '#4a90d9', r: 15, hp: 22, atk: 6, speed: 1.6, xp: 14, lore: "A soulless guard of Azkaban that feeds on happiness, leaving only cold and despair behind. It does not walk. It glides." },
  deatheater: { name: 'Death Eater', kind: 'humanoid', variant: 'shadow', color: '#141414', accent: '#3a5c3a', r: 14, hp: 19, atk: 5, speed: 2.4, xp: 12, lore: "A masked follower of the Dark Lord, marked on the forearm and loyal past all reason. Cornered, they become more dangerous, not less." },
}

const BOSS_DEFS = {
  trickstepslime: { name: 'Grimald, the Trick-Step Slime', kind: 'ooze', color: '#8a7a5a', accent: '#FFD34D', crown: true, r: 30, hp: 120, atk: 7, speed: 1.3, xp: 70, lore: "Something has been living in the castle's famous trick step for longer than any living portrait can remember, and it has grown proprietary about the real estate." },
  gnomechieftain: { name: 'Grubwick, the Gnome Chieftain', kind: 'humanoid', variant: 'goblin', color: '#6a5228', accent: '#FFD34D', crown: true, r: 30, hp: 160, atk: 9, speed: 1.5, xp: 110, lore: "Crowned by his own kind after successfully de-gnoming the de-gnomer. He has not forgotten the indignity, nor forgiven it." },
  rustedknight: { name: 'The Ancient Rusted Knight', kind: 'golem', variant: 'rust', color: '#7a4a2a', accent: '#ffcf80', r: 30, hp: 190, atk: 10, speed: 2.4, xp: 150, lore: "The oldest suit of armor in the castle, so encrusted with age nobody remembers which battle it was forged for \u2014 only that it hasn't forgotten how to fight." },
  anatomyskeleton: { name: 'Old Bonecrackle, the Anatomy Skeleton', kind: 'humanoid', variant: 'bone', color: '#e8dcc0', accent: '#2a2a2a', scythe: true, r: 32, hp: 220, atk: 12, speed: 1.6, xp: 190, lore: "The Potions classroom's anatomy model, animated by decades of stray magic and a deep, abiding resentment of pop quizzes." },
  whompingwillow: { name: 'The Whomping Willow', kind: 'plant', color: '#3a5c2a', accent: '#ff8f4a', r: 34, hp: 300, atk: 15, speed: 1.7, xp: 300, lore: "Planted to conceal a very specific secret and instructed to hit first and ask no questions. It has never once needed reminding." },
  belfrydoxy: { name: 'Vesper, the Belfry Doxy', kind: 'flyer', variant: 'bat', color: '#4a2a5a', accent: '#ff9fe0', r: 32, hp: 345, atk: 17, speed: 1.4, xp: 207, lore: "The eldest of the Owlery's doxy infestation, grown fat and vicious on centuries of undisturbed nesting. She does not share." },
  runespoorelder: { name: 'The Runespoor Elder', kind: 'serpent', heads: 3, color: '#5a8a3a', accent: '#c9e08a', r: 32, hp: 390, atk: 19, speed: 2.0, xp: 234, lore: "A runespoor grown ancient and enormous on the Grand Staircase's shifting stonework, its three heads long past agreeing on anything \u2014 including when to strike." },
  roguebludger: { name: 'The Rogue Bludger', kind: 'orb', variant: 'eye', color: '#1a1a1a', accent: '#ff3b3b', r: 32, hp: 435, atk: 21, speed: 2.6, xp: 261, lore: "A Quidditch Bludger that was never properly re-caged after a match gone wrong. It still remembers which team it was hunting." },
  frozensentinel: { name: 'The Frozen Sentinel', kind: 'humanoid', variant: 'ice', color: '#9fd8ff', accent: '#e9fbff', bulky: true, r: 33, hp: 480, atk: 23, speed: 1.2, xp: 288, lore: "Something in the Divination Tower's fog has taken on solid, freezing form, drawn there by decades of nervous students predicting their own doom." },
  giltsentinel: { name: 'The Gilded Sentinel', kind: 'golem', variant: 'gold', color: '#d4af37', accent: '#fff4c9', r: 33, hp: 525, atk: 25, speed: 1.8, xp: 315, lore: "A golden guardian said to have once stood watch in the Great Hall, now animated and none too pleased about being disturbed after hours." },
  hippogriffmatriarch: { name: 'The Hippogriff Matriarch', kind: 'flyer', variant: 'harpy', color: '#8a6a3a', accent: '#e0c090', crown: true, r: 34, hp: 570, atk: 27, speed: 1.3, xp: 342, lore: "Proud, sharp-eyed, and fiercely territorial of the skies above Hogsmeade. Bow first. Ask questions never." },
  mountaintroll: { name: 'The Mountain Troll', kind: 'humanoid', variant: 'ogre', color: '#5c6a4a', accent: '#2f3a20', bulky: true, r: 34, hp: 615, atk: 29, speed: 3.0, xp: 369, lore: "Enormous, club-wielding, and none too bright \u2014 which makes it no less dangerous at the edge of the Forbidden Forest." },
  skewtalpha: { name: 'The Blast-Ended Skrewt Alpha', kind: 'imp', variant: 'fire', demon: true, color: '#ff5533', accent: '#ffd34d', r: 34, hp: 660, atk: 31, speed: 1.7, xp: 396, lore: "Hagrid's prize specimen, grown far larger \u2014 and far more explosive \u2014 than any textbook recommends." },
  manticore: { name: 'The Manticore', kind: 'beast', variant: 'wolf', chimera: true, color: '#8a3a2a', accent: '#ffd060', r: 35, hp: 705, atk: 33, speed: 2.2, xp: 423, lore: "A fully grown manticore, said to speak in a voice smooth enough to make its human face genuinely unsettling right up until the sting lands." },
  forbiddengrimoire: { name: 'The Forbidden Grimoire', kind: 'mimic', color: '#3a2a4a', accent: '#c9a6ff', r: 35, hp: 750, atk: 35, speed: 1.6, xp: 450, lore: "The Restricted Section's oldest and hungriest book, chained for good reason \u2014 and no longer entirely contained by the chain." },
  peeves: { name: 'Peeves the Poltergeist', kind: 'spectral', variant: 'banshee', color: '#e8f0ff', accent: '#ff9fe0', crown: true, r: 35, hp: 795, atk: 37, speed: 2.1, xp: 477, lore: "The castle's oldest and least remorseful troublemaker. Ask any professor. They'll sigh before they answer." },
  boggartking: { name: 'The Boggart King', kind: 'humanoid', variant: 'shadow', color: '#2a1a3a', accent: '#9a6bff', crown: true, r: 36, hp: 840, atk: 39, speed: 2.4, xp: 504, lore: "Whatever this is, it isn't one fear \u2014 it's every fear in the castle, layered on top of each other until even it isn't sure what it looks like." },
  basilisk: { name: 'The Basilisk', kind: 'serpent', color: '#1a4a2a', accent: '#d4ff00', r: 40, hp: 1700, atk: 55, speed: 2.0, xp: 1000, lore: "A serpent old enough to remember when the Chamber was first sealed, capable of killing with a single glance. Older than anyone currently in the castle. Immeasurably more dangerous." },
  dementorwarden: { name: 'The Dementor Warden', kind: 'spectral', variant: 'banshee', crown: true, color: '#0f0f18', accent: '#4a90d9', r: 38, hp: 1900, atk: 58, speed: 1.8, xp: 1150, lore: "The eldest and coldest of Azkaban's guards, sent out when the fortress itself is no longer enough to hold what's inside." },
  nagini: { name: 'Nagini', kind: 'serpent', color: '#0a2a0a', accent: '#8fff4a', r: 36, hp: 2100, atk: 62, speed: 2.4, xp: 1300, lore: "Enormous, ancient, and fiercely loyal to only one master. Wherever she is, he is rarely far behind." },
  voldemort: { name: 'Lord Voldemort', kind: 'humanoid', variant: 'shadow', scythe: true, color: '#12100e', accent: '#ff2a2a', r: 40, hp: 3000, atk: 80, speed: 2.2, xp: 2000, lore: "He who nearly ended the wizarding world once already, and fully intends to finish the job. The rumors were never exaggerated." },
}

const WEAPONS = [
  { name: 'Willow Wand', emoji: '🪄', atk: 2 },
  { name: 'Ash Wand', emoji: '🪄', atk: 4 },
  { name: 'Vine Wand', emoji: '🪄', atk: 6 },
  { name: 'Cherry Wand', emoji: '🪄', atk: 9 },
  { name: 'Cedar Wand', emoji: '🪄', atk: 13 },
  { name: 'Ebony Wand', emoji: '🪄', atk: 18 },
  { name: 'Mahogany Wand', emoji: '🪄', atk: 24 },
  { name: 'Rowan Wand', emoji: '🪄', atk: 31 },
  { name: 'Hazel Wand', emoji: '🪄', atk: 39 },
  { name: 'Blackthorn Wand', emoji: '🪄', atk: 48 },
  { name: 'Yew Wand', emoji: '✨', atk: 58 },
  { name: 'Hawthorn Wand', emoji: '✨', atk: 69 },
  { name: 'Chestnut Wand', emoji: '✨', atk: 81 },
  { name: 'Beechwood Wand', emoji: '🌟', atk: 94 },
  { name: 'Holly Wand', emoji: '🌟', atk: 108 },
  { name: 'Acacia Wand', emoji: '🌟', atk: 123 },
  { name: 'Elm Wand', emoji: '🌟', atk: 139 },
  { name: 'Elder Wand', emoji: '👑', atk: 156 },
]
const ARMORS = [
  { name: 'Hand-Me-Down Robes', emoji: '👘', def: 1 },
  { name: 'Patched School Cloak', emoji: '🧥', def: 2 },
  { name: 'Pointed Wizard Hat', emoji: '🎩', def: 4 },
  { name: 'Dragonhide Gloves', emoji: '🧤', def: 6 },
  { name: 'Warming Charm Cloak', emoji: '🧣', def: 9 },
  { name: 'House Colors Scarf', emoji: '🧣', def: 13 },
  { name: "Prefect's Robes", emoji: '👘', def: 18 },
  { name: "Quidditch Captain's Pads", emoji: '🛡️', def: 24 },
  { name: 'Goblin-Silver Chainmail', emoji: '🛡️', def: 31 },
  { name: 'Enchanted Traveling Cloak', emoji: '🧥', def: 39 },
  { name: "Runed Duelist's Robes", emoji: '👘', def: 48 },
  { name: 'Basilisk-Hide Vest', emoji: '🛡️', def: 58 },
  { name: 'Phoenix-Down Cloak', emoji: '🧥', def: 69 },
  { name: "Merlin's Own Robes", emoji: '👘', def: 81 },
  { name: 'Goblin-Forged Battle Armor', emoji: '🛡️', def: 94 },
  { name: 'Order of Merlin Robes', emoji: '🌟', def: 108 },
  { name: "Headmaster's Ceremonial Robes", emoji: '👑', def: 123 },
]

const SPELLS = [
  { id: 'bolt', name: 'Stupefy', emoji: '⚡', kind: 'projectile', baseCost: 14, cooldown: 30, baseDamage: 6, splash: 0 },
  { id: 'fireball', name: 'Incendio', emoji: '🔥', kind: 'projectile', baseCost: 22, cooldown: 66, baseDamage: 14, splash: 40 },
  { id: 'ice', name: 'Glacius', emoji: '❄️', kind: 'projectile', baseCost: 16, cooldown: 42, baseDamage: 7, splash: 0, slowMult: 0.4, slowFrames: 120 },
  { id: 'chainzap', name: 'Expelliarmus', emoji: '💫', kind: 'projectile', baseCost: 20, cooldown: 54, baseDamage: 5, splash: 70 },
  { id: 'snackheal', name: 'Episkey', emoji: '💚', kind: 'heal', baseCost: 18, cooldown: 96, baseHeal: 14 },
]

const CLASSES = [
  { id: 'warrior', name: 'Gryffindor', emoji: '🦁', desc: 'Brave and bold: more attack, more health.', atk: 3, def: 1, hp: 10, mana: 0 },
  { id: 'mage', name: 'Ravenclaw', emoji: '🦅', desc: 'A clever glass-cannon spellcaster: huge mana pool, less health.', atk: -1, def: 0, hp: -6, mana: 20 },
  { id: 'rogue', name: 'Slytherin', emoji: '🐍', desc: 'Cunning and quick, with a little extra mana.', atk: 1, def: 0, hp: 0, mana: 5, speedMult: 1.15 },
  { id: 'cleric', name: 'Hufflepuff', emoji: '🦡', desc: 'Loyal and tough, with solid defense and mana.', atk: 0, def: 2, hp: 6, mana: 10 },
]
const RACES = [
  { id: 'human', name: 'Phoenix Feather', emoji: '🪶', desc: 'Balanced all-rounder — the core that chooses wisely.', atk: 1, def: 1, hp: 4, mana: 4 },
  { id: 'elf', name: 'Dragon Heartstring', emoji: '🐉', desc: 'Extra mana and speed, but fragile — powerful, flashy magic.', atk: 0, def: 0, hp: -4, mana: 12, speedMult: 1.1 },
  { id: 'dwarf', name: 'Unicorn Hair', emoji: '🦄', desc: 'Tough and steady, but a little slow — the most reliable core.', atk: 0, def: 2, hp: 10, mana: 0, speedMult: 0.92 },
  { id: 'hamsterkin', name: 'Veela Hair', emoji: '🧚', desc: 'Fast and lucky with Galleons, but a lighter hitter — temperamental magic.', atk: -1, def: 0, hp: 0, mana: 0, speedMult: 1.2, goldMult: 1.2 },
]

const ACHIEVEMENTS = [
  { id: 'contestant', name: 'Welcome to Hogwarts', desc: 'Step through the castle doors.' },
  { id: 'firstblood', name: 'Flobberworm Squasher', desc: 'Defeat your first creature.' },
  { id: 'lootgoblin', name: 'Treasure Hound', desc: 'Open 5 chests.' },
  { id: 'gnomebuster', name: 'De-Gnomed!', desc: 'Defeat a Garden Gnome.' },
  { id: 'snackbreak', name: 'Elixir Break', desc: 'Drink a potion.' },
  { id: 'bossbeat1', name: 'Detention Survivor', desc: "Defeat an area's guardian creature." },
  { id: 'geared', name: 'Well-Equipped Wizard', desc: 'Equip a wand and robes.' },
  { id: 'spellcaster', name: 'First Incantation', desc: 'Cast your first spell.' },
  { id: 'spellbound', name: 'Master of Charms', desc: 'Learn all 5 spells.' },
  { id: 'archmage', name: 'O.W.L.-Worthy', desc: 'Level a spell up to level 5.' },
  { id: 'oof', name: 'Sent to the Hospital Wing', desc: 'Get knocked out (Madam Pomfrey has seen worse).' },
  { id: 'richkid', name: 'Pocket Full of Galleons', desc: 'Collect 200 Galleons.' },
  { id: 'champion', name: 'Vanquisher of the Dark Lord', desc: 'Defeat Lord Voldemort and end the war.' },
]

const PET_LINES = {
  intro: ["Wait, why can I talk?! Also — why does this castle feel like it's holding its breath?", 'This seems fine. This seems totally fine.', "I don't like this. Cats know things."],
  floorStart: ['New corridor. New ways for us both to get hurt, probably.', "I've got a bad feeling about this one.", "Try not to trip. I'm watching. Judging, a little."],
  lowHp: ["You're bleeding. That's not great.", 'That is a LOT of ouch. Potion. Now.', "I would not survive that. Good thing it's you and not me."],
  bossIntro: ["That thing looks like it wants to eat both of us. I'll be over here.", "Big. Dangerous. You've got this. Probably.", 'On the count of three, you go first. One, two — go!'],
  levelUp: ['Look at you go. Very impressive, for a non-cat.', "Stronger. Good. You'll need it.", 'Level up. I take full credit for the moral support.'],
  idle: ['Does this castle have a kitchen? Asking for a friend.', "I've decided my job here is 'vigilance'.", 'Statistically, we should be more scared than we are.', 'Is it just me, or does that suit of armor look suspicious?'],
  victory: ['We did it. Well, YOU did it. I supervised.', 'Put that on my resume: Survived a Dark Lord.', "I've seen enough excitement for one lifetime."],
}
const ANNOUNCER_LINES = {
  welcome: ['Welcome to Hogwarts. Dark times are stirring, but the castle still stands.', 'The other portraits are anxious tonight. Keep your wand close.'],
  floorStart: ['Onward. The castle has more to show you — not all of it kind.', 'Another corridor. Stay alert.'],
  bossIntro: ['Something is guarding this place. Draw your wand.', 'I would not blame you for hesitating. Go carefully.'],
  bossDefeat: ["Well fought. Not every portrait in this castle can say they've witnessed that.", 'It falls. The corridor is yours — for now.'],
  levelUp: ['You grow stronger. You will need to.', 'Good. The days ahead will demand more of you.'],
  win: ['He has fallen. Hogwarts is safe — for now.', 'The Dark Lord is defeated. The castle will remember this night.'],
  knockout: ['Get to the Hospital Wing. Now.', 'That was too close. Be more careful.'],
  idle: ['Filch is prowling somewhere nearby — mind the rules, even now.', 'Every portrait in this hall is watching. None of us sleep easy these days.', 'Somewhere below, something is still counting the days.'],
}
...
function learnOrLevelSpell(g, player, id) {
  ...
  if (!known) {
    ...
    player.gold += gold
    pushBanner(g, '💰', `Already mastered ${def.name} — sold the spare scroll for ${gold} Galleons`, '#FFD34D')
  }
}
...
function knockoutPlayer(g, player) {
  pushBanner(g, '💫', "Struck down — dragged off to the Hospital Wing.", '#FF9E6B')
...
function onMonsterDeath(g, player, m) {
  ...
  if (m.type === 'gardengnome') grantAchievement(g, 'gnomebuster')
  if (Math.random() < 0.1) { player.potions = Math.min(5, player.potions + 1); pushBanner(g, '🧪', 'A healing elixir fell out!', '#7CFF6B') }
  if (m.isBoss) {
...
function openChest(g, player, c) {
  ...
  if (roll < 0.3) {
    ...
    player.gold += amt
    pushBanner(g, '🪙', `Found ${amt} Galleons!`, '#FFD34D')
  } else if (roll < 0.5) {
    player.potions = Math.min(5, player.potions + 1)
    pushBanner(g, '🧪', 'Found a healing elixir!', '#7CFF6B')
  } else if (roll < 0.65) {
    ...
    if (w.atk > player.weaponAtk) {
      ...
      player.gold += gold
      pushBanner(g, '💰', `Found ${w.name}, sold for ${gold} Galleons`, '#FFD34D')
    }
  } else if (roll < 0.8) {
    ...
    if (a.def > player.armorDef) {
      ...
      player.gold += gold
      pushBanner(g, '💰', `Found ${a.name}, sold for ${gold} Galleons`, '#FFD34D')
    }
  } else {
...
function advanceFloor(g, helpers) {
  ...
  g.frame = 0
  pushBanner(g, '🚪', `${floor.theme.act} — ${floor.theme.name}`, floor.theme.accent)
...
function updatePlayerActions(g, player, pressed) {
  ...
  if (pressed.potion) {
    if (player.potionCooldown <= 0 && player.potions > 0 && player.hp < player.maxHp) {
      ...
      pushBanner(g, '🧪', 'Elixir break! HP restored.', '#7CFF6B')
...
function drawPlayerStatsBox(ctx, p, barX, barY, label) {
  ...
  ctx.fillText(`🪙 ${p.gold}g`, barX, rowY)
...
function drawHUD(g, ctx, W, H) {
  ...
  ctx.fillText(`${g.theme.act.split(':')[0]} · ${g.theme.name}`, W / 2, 20)
  ...
  if (g.announcerTimer > 0) {
    ...
    ctx.textAlign = 'center'
    ctx.fillText(`🖼️ Sir Reginald: "${g.announcerText}"`, W / 2, H - 70)
    ctx.globalAlpha = 1
  }
  ...
  if (g.petTimer > 0) {
    ...
    ctx.globalAlpha = alpha
    const text = `🐈 Marmalade: "${g.petText}"`
  ...
  if (g.floorIndex === 0 && g.frame < 600) {
    ...
    const hint = g.twoPlayer
      ? 'P1: WASD move · Space attack · F cast spell · E potion — P2: Arrows move · / attack · . cast spell · , potion — I spellbook'
...
// ── Component ────────────────────────────────────────────────────────
export default function HogwartsSpellbound() {
  ...
  const [bestiaryTab, setBestiaryTab] = useState('creatures')
  const bestiaryReturnRef = useRef('intro')
  const bestiaryPortraitsRef = useRef([])

  function setPhase(p) { phaseRef.current = p; setPhaseState(p) }
  function openBestiary() {
    bestiaryReturnRef.current = phaseRef.current === 'bestiary' ? 'intro' : phaseRef.current
    bestiaryPortraitsRef.current = []
  ...
  function closeBestiary() { setPhase(bestiaryReturnRef.current) }
  function areasFor(id, isBoss) {
    return FLOOR_THEMES.filter(t => (isBoss ? t.boss === id : t.monsterPool.includes(id))).map(t => t.name)
  }
  ...
  useEffect(() => {
    const onKeyDown = (e) => {
      ...
      if (e.code === 'KeyB') {
        if (phaseRef.current === 'playing' || phaseRef.current === 'intro') openBestiary()
        else if (phaseRef.current === 'bestiary') closeBestiary()
      }
    }
  ...
  useEffect(() => {
    if (phase !== 'bestiary') return
    let raf
    function loop(t) {
      const frame = t / 16.67
      for (const entry of bestiaryPortraitsRef.current) {
        if (!entry || !entry.canvas) continue
        const ctx = entry.canvas.getContext('2d')
        ctx.clearRect(0, 0, entry.canvas.width, entry.canvas.height)
        drawCreature(ctx, {
          x: entry.canvas.width / 2, y: entry.canvas.height / 2,
          r: Math.min(entry.def.r, 34), kind: entry.def.kind, variant: entry.def.variant || null,
          color: entry.def.color, accent: entry.def.accent,
          crown: !!entry.def.crown, bulky: !!entry.def.bulky, chimera: !!entry.def.chimera,
          heads: entry.def.heads || 1, demon: !!entry.def.demon, scythe: !!entry.def.scythe,
          id: entry.idNum, isBoss: entry.isBoss,
        }, frame)
      }
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {phase === 'intro' && (
        <div className={styles.overlay}>
          <div className={styles.card}>
            <div className={styles.emojiRow}>{twoPlayer ? '🧙 🧙‍♀️ 🐈 🏰' : '🧙 🐈 🏰'}</div>
            <h1 className={styles.title}>Hogwarts: Spellbound</h1>
            <p className={styles.tagline}>Dark Times Have Come to Hogwarts</p>
            <p className={styles.story}>
              You{twoPlayer ? ' and a friend' : ''} — and your familiar, Marmalade the cat — have arrived at
              Hogwarts School of Witchcraft and Wizardry in troubled times. Dark magic is stirring again,
              and something ancient has woken beneath the castle. A talking portrait named Sir Reginald
              will show you around while the other portraits watch nervously. Explore every corridor, duel
              dangerous creatures and Death Eaters alike, loot chests, and grow stronger. You'll{twoPlayer ? ' both ' : ' '}
              be Sorted and choose a wand core after your third corridor, and spell scrolls found in chests
              can be leveled up and equipped from your spellbook. Getting struck down means a trip to the
              Hospital Wing — try to avoid it. Twenty-one corridors stand between you and Lord Voldemort
              himself.
            </p>
            ...
            <div className={styles.controls}>
              ...
              <span><b>Monster Book</b> — B</span>
            </div>
            <div className={styles.row2}>
              <button className={styles.startButton} onClick={startGame}>Step Through The Castle Doors →</button>
              <button className={styles.secondaryButton} onClick={openBestiary}>📖 Monster Book</button>
            </div>
          </div>
        </div>
      )}
      ...
      {phase === 'classPick' && (
        <div className={styles.overlay}>
          <div className={styles.card}>
            <h1 className={styles.title}>Choose Your House &amp; Wand Core</h1>
            <p className={styles.tagline}>Corridor 3 awaits — the Sorting Hat wants your answer before you go in.</p>
            ...
            {(twoPlayer ? [['p1', 'Player 1'], ['p2', 'Player 2']] : [['p1', null]]).map(([key, label]) => (
              <div key={key} className={styles.pickPlayerBlock}>
                ...
                <p className={styles.pickLabel}>House</p>
                <div className={styles.pickRow}>
                  {CLASSES.map(c => (
                    <button
                      key={c.id}
                ...
                <p className={styles.pickLabel}>Wand Core</p>
                <div className={styles.pickRow}>
                  {RACES.map(r => (
                    <button
                      key={r.id}
      ...
      {phase === 'spellbook' && spellSnapshot && (
        <div className={styles.overlay}>
          <div className={styles.card}>
            ...
            <button className={styles.startButton} onClick={() => setPhase('playing')}>Back To The Castle →</button>
          </div>
        </div>
      )}
      ...
      {phase === 'bestiary' && (
        <div className={styles.overlay}>
          <div className={`${styles.card} ${styles.bestiaryPanel}`}>
            <h1 className={styles.title}>📖 Monster Book</h1>
            <p className={styles.tagline}>Everything known about the creatures and guardians of Hogwarts.</p>
            <div className={styles.gearTabs}>
              <button className={`${styles.gearTabBtn} ${bestiaryTab === 'creatures' ? styles.gearTabActive : ''}`} onClick={() => switchBestiaryTab('creatures')}>
                Creatures ({Object.keys(MONSTER_DEFS).length})
              </button>
              <button className={`${styles.gearTabBtn} ${bestiaryTab === 'guardians' ? styles.gearTabActive : ''}`} onClick={() => switchBestiaryTab('guardians')}>
                Corridor Guardians ({Object.keys(BOSS_DEFS).length})
              </button>
            </div>
            <div className={styles.bestiaryGrid}>
              {Object.entries(bestiaryTab === 'guardians' ? BOSS_DEFS : MONSTER_DEFS).map(([id, def], idx) => {
                const isBoss = bestiaryTab === 'guardians'
                const areas = areasFor(id, isBoss)
                return (
                  <div key={id} className={styles.bestiaryEntry}>
                    <canvas
                      width={96}
                      height={96}
                      className={styles.bestiaryPortraitWrap}
                      ref={el => { if (el) bestiaryPortraitsRef.current[idx] = { canvas: el, def, idNum: idx, isBoss } }}
                    />
                    <div className={styles.bestiaryInfo}>
                      <p className={styles.bestiaryName}>{def.name}</p>
                      ...
                      <p className={styles.bestiaryLore}>{def.lore}</p>
                      {areas.length > 0 && (
                        <p className={styles.bestiaryFound}>{isBoss ? 'Guards: ' : 'Found in: '}{areas.join(', ')}</p>
                      )}
                    </div>
                  </div>
                )
            ...
            <button className={styles.startButton} onClick={closeBestiary}>
              {bestiaryReturnRef.current === 'playing' ? 'Back To The Castle →' : 'Close →'}
            </button>
          </div>
        </div>
      )}
      ...
      {phase === 'win' && winStats && (
        <div className={styles.overlay}>
          <div className={styles.card}>
            <h1 className={styles.title}>🏆 You've Conquered Hogwarts!</h1>
            <p className={styles.story}>Sir Reginald: "A CHAMPION OF HOGWARTS, AT LAST! Every portrait in this castle will be talking about you for centuries!"</p>
            <div className={styles.statsList}>
              <div>Final Level: <b>{winStats.level}</b></div>
              <div>Galleons Collected: <b>{winStats.gold}</b> 🪙</div>
