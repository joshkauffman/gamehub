...
export default function DungeonCrawlerMax() {
  ...
  function startGame() {
    ...
    // Coins found in any of this hub's Dungeon Crawler Max games (or
    // Hogwarts: Spellbound) carry over — see ../../shared/sharedCoins.js.
    // Player 2 keeps their own per-run-only gold, same as before.
